  ...
  <section>
    <div id="schedule">
      ...
      >
        ...
        <h3>
          {{ this.$store.state.obj.date.split("-").reverse().join(" / ") }}
        </h3>
      </b-row>
      <b-row
        cols="12"
...
export default {
  ...
  methods: {
            ...
            Object.values(e).forEach((el, index2) => {
              ...
              if (date > today) {
                if (
                  ...
                  Object.keys(this.items[index1])[index2] != "numero"
                ) {
    ...
    clickOnCell(e) {
      if (
        e.srcElement.cellIndex != 0 &&
        e.srcElement.parentNode.rowIndex != 0
      ) {
        if (this.checkDate()) {
          ...
          obj.valor = e.srcElement.children[0].innerHTML;
          if (Object.keys(this.$store.state.user).length) {
            if (
              ...
              if (
                e.srcElement.children[0].innerHTML == 0 ||
                e.srcElement.children[0].innerHTML == 1
              ) {
                if (
                ...
                } else if (e.srcElement.children[0].innerHTML == 0) {
